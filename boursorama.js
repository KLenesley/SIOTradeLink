...
function addRedirectionButton() {
  ...
  const match = html.match(/\/bourse\/cours\/ajax\/autres-places-de-quotation\/([A-Z0-9]+)/);
  ...
  if (match) {
    ...
    button.textContent = 'Voir sur Planspiel';
    ...
    button.addEventListener('click', () => {
      const url = `https://trading.planspiel-boerse.de/web/instrument/${id}/information`;
